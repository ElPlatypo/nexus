...
def setup_logger(name:str, max_level = logging.DEBUG) -> logging.Logger:
    ...
    print_formatter = logging.Formatter(Fore.CYAN + "%(asctime)s" + Fore.WHITE + " %(name)s %(levelname)s " + Fore.CYAN + "> %(message)s" + Fore.WHITE, "%H:%M:%S")
